...
<div class="buttons-container">
  <button id="button1" onclick="toggleVisibility('button2', 'button1'); window.location.href = 'unavailable.php'">UNAVAILABLE</button>
  <button id="button2" style="display: none;" onclick="toggleVisibility('button1', 'button2')">AVAILABLE</button>
</div>
